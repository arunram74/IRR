...
Public Class frmLoad
    ...
    Private Sub frmProfile_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        If Station.MC.myProj.MyStatus = ProjectCls.ProjectStatus.Run Or Station.MC.myProj.MyStatus = ProjectCls.ProjectStatus.Load Then Panel1.Enabled = False Else Panel1.Enabled = True
    ...
    Private Sub Bordergray(sender As Object, e As PaintEventArgs) Handles PictureBox7.Paint
