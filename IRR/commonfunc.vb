...
Module commonfunc
    ...
    Public serv As String = "server = localhost; user id =root; password =Actemium#123; database =timken_irr" 'global connection string variable
    ...
    Public Structure SingleLimits
        ...
        Public Sub Init(TagNameStr As String)
            Value = 0
