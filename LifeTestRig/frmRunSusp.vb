...
Public Class frmRunSusp
    ...
    Private Sub frmTestComplete_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        If CurrentHead.myProj.MyStatus = ProjectCls.ProjectStatus.Run Or CurrentHead.myProj.MyStatus = ProjectCls.ProjectStatus.Load Then rndBtnRun.Enabled = False Else rndBtnRun.Enabled = True
        If CurrentHead.myProj.MyStatus <> ProjectCls.ProjectStatus.Run And CurrentHead.myProj.MyStatus <> ProjectCls.ProjectStatus.Load Then
    ...
    Private Sub rndBtnFailed_Click(sender As Object, e As EventArgs)
        If CurrentHead.myProj.ProjectID <> 0 Then
            ...
            If str <> "" Then
                CurrentHead.myProj.FailTest(str)
                If HeadPairBonded Then PairHead.myProj.FailTest(str)
            End If
            Me.Close()
        End If
    End Sub
    ...
    Private Sub rndBtnSuspend_Click(sender As Object, e As EventArgs) Handles rndBtnSuspend.Click
        If CurrentHead.myProj.MyStatus = ProjectCls.ProjectStatus.Run Or CurrentHead.myProj.MyStatus = ProjectCls.ProjectStatus.Load Then
            ...
            If str <> "" Then
                CurrentHead.myProj.StopReason = str
                CurrentHead.myProj.MyStatus = ProjectCls.ProjectStatus.Suspended
                If HeadPairBonded Then
                    PairHead.myProj.StopReason = str
                    PairHead.myProj.MyStatus = ProjectCls.ProjectStatus.Suspended
                End If
            End If
            Me.Close()
        End If
    ...
    Private Sub rndBtnRun_Click(sender As Object, e As EventArgs) Handles rndBtnRun.Click
        ...
        CurrentHead.myProj.IsPairBonded = HeadPairBonded


        If CurrentHead.myProj.StartTest() Then
            If HeadPairBonded Then
                PairHead.myProj.IsPairBonded = HeadPairBonded
                PairHead.myProj.StartTest()
            End If
        Else
