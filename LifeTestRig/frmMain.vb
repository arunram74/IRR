...
Public Class frmMain
    ...
    Private Sub frmMain_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        bkgrndWrkr2.RunWorkerAsync(PLCStations)
        bkgrndWrkr3.RunWorkerAsync(PLCStations)
        bkgrndWrkr4.RunWorkerAsync(PLCStations)
...
#Region "ClickEvents"
    ...
    Private Sub ToolStripButton1_Click_1(sender As Object, e As EventArgs) Handles toolBtnOpenPrj.Click
        If frmOpenExistingPrj.ShowDialog() = Windows.Forms.DialogResult.OK Then
            ...
            If Station.MC1.HeadA.myProj.ProjectID = frmOpenExistingPrj.PrjID Then
                MessageBox.Show("Cannot load this project", System.Reflection.MethodBase.GetCurrentMethod().Name, MessageBoxButtons.OK, MessageBoxIcon.Error)
                Exit Sub
            End If
            If Station.MC1.HeadB.myProj.ProjectID = frmOpenExistingPrj.PrjID Then
                MessageBox.Show("Cannot load this project", System.Reflection.MethodBase.GetCurrentMethod().Name, MessageBoxButtons.OK, MessageBoxIcon.Error)
                Exit Sub
            End If
            If Station.MC2.HeadA.myProj.ProjectID = frmOpenExistingPrj.PrjID Then
                MessageBox.Show("Cannot load this project", System.Reflection.MethodBase.GetCurrentMethod().Name, MessageBoxButtons.OK, MessageBoxIcon.Error)
                Exit Sub
            End If
            If Station.MC2.HeadB.myProj.ProjectID = frmOpenExistingPrj.PrjID Then
                MessageBox.Show("Cannot load this project", System.Reflection.MethodBase.GetCurrentMethod().Name, MessageBoxButtons.OK, MessageBoxIcon.Error)
                Exit Sub
            End If
            If Station.MC3.HeadA.myProj.ProjectID = frmOpenExistingPrj.PrjID Then
                MessageBox.Show("Cannot load this project", System.Reflection.MethodBase.GetCurrentMethod().Name, MessageBoxButtons.OK, MessageBoxIcon.Error)
                Exit Sub
            End If
            If Station.MC3.HeadB.myProj.ProjectID = frmOpenExistingPrj.PrjID Then
                MessageBox.Show("Cannot load this project", System.Reflection.MethodBase.GetCurrentMethod().Name, MessageBoxButtons.OK, MessageBoxIcon.Error)
                Exit Sub
            End If
            If Station.MC4.HeadA.myProj.ProjectID = frmOpenExistingPrj.PrjID Then
                MessageBox.Show("Cannot load this project", System.Reflection.MethodBase.GetCurrentMethod().Name, MessageBoxButtons.OK, MessageBoxIcon.Error)
                Exit Sub
            End If
            If Station.MC4.HeadB.myProj.ProjectID = frmOpenExistingPrj.PrjID Then
                MessageBox.Show("Cannot load this project", System.Reflection.MethodBase.GetCurrentMethod().Name, MessageBoxButtons.OK, MessageBoxIcon.Error)
                Exit Sub
            End If

            CurrentHead.myProj.LoadExisting(frmOpenExistingPrj.PrjID)
            CurrentHead.myProj.isNew = False
    ...
    Sub LogLubOilData()
        ...
        Try
            ...
            sqlCommand.Parameters.AddWithValue("@lbmc2", Station.Comms.PLC2.GetTagVal("InTankTemp_actVal"))
            sqlCommand.Parameters.AddWithValue("@lbmc3", Station.Comms.PLC3.GetTagVal("InTankTemp_actVal"))
            sqlCommand.Parameters.AddWithValue("@lbmc4", Station.Comms.PLC4.GetTagVal("InTankTemp_actVal"))
...
#End Region
    ...
    Private Sub bkgrndWrkr2_DoWork(sender As Object, e As System.ComponentModel.DoWorkEventArgs) Handles bkgrndWrkr2.DoWork
    ...
    Private Sub bkgrndWrkr2_RunWorkerCompleted(sender As Object, e As RunWorkerCompletedEventArgs) Handles bkgrndWrkr2.RunWorkerCompleted
        For i = 4 To 6
            PLCStations(i).Stn.Close()
        Next i
    End Sub

    Private Sub bkgrndWrkr3_DoWork(sender As Object, e As System.ComponentModel.DoWorkEventArgs) Handles bkgrndWrkr3.DoWork
    ...
    Private Sub bkgrndWrkr3_RunWorkerCompleted(sender As Object, e As RunWorkerCompletedEventArgs) Handles bkgrndWrkr3.RunWorkerCompleted
        For i = 7 To 9
            PLCStations(i).Stn.Close()
        Next i
    End Sub

    Private Sub bkgrndWrkr4_DoWork(sender As Object, e As System.ComponentModel.DoWorkEventArgs) Handles bkgrndWrkr4.DoWork
    ...
    Private Sub bkgrndWrkr4_RunWorkerCompleted(sender As Object, e As RunWorkerCompletedEventArgs) Handles bkgrndWrkr4.RunWorkerCompleted
        For i = 10 To 12
            PLCStations(i).Stn.Close()
        Next i
    End Sub
