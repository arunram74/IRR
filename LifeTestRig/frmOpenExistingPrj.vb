...
Public Class frmOpenExistingPrj
    ...
    Sub LoadValues()
        ...
        " and ProjectID<>" & Station.MC1.HeadA.myProj.ProjectID &
        " and ProjectID<>" & Station.MC1.HeadB.myProj.ProjectID &
        " and ProjectID<>" & Station.MC2.HeadA.myProj.ProjectID &
        " and ProjectID<>" & Station.MC2.HeadB.myProj.ProjectID &
        " and ProjectID<>" & Station.MC3.HeadA.myProj.ProjectID &
        " and ProjectID<>" & Station.MC3.HeadA.myProj.ProjectID &
        " and ProjectID<>" & Station.MC4.HeadB.myProj.ProjectID &
        " and ProjectID<>" & Station.MC4.HeadA.myProj.ProjectID &
